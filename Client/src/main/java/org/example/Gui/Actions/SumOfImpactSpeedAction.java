...
public class SumOfImpactSpeedAction extends AbstractAction {
    private final User user;
    private final Client client;

    public SumOfImpactSpeedAction(User user, Client client) {
        super();
        this.user = user;
        this.client = client;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        Response response = client.getResponse(new Request("sum_of_impact_speed", "", user, GuiManager.getLocale()));
